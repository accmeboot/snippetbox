...
import (
	...
	"snippetbox.accme.com/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This field cannot contain more then 100 characters")
...
func (app *application) userSingupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Name), "name", "This filed cannot be blank")
	form.CheckField(validator.NotBlank(form.Email), "email", "This filed cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This filed must be valid email address")
	...
	if err != nil {
		if errors.Is(err, models.ErrDuplicateEmail) {
			...
			data := app.newTemplateData(r)
			data.Form = form
			app.render(w, http.StatusUnprocessableEntity, "singup.html", data)
		} else {
			app.serverError(w, err)
		}
